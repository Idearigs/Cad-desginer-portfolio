...
class EventsHandler {
    ...
    showEventBanner() {
        ...
        // Force hide no events section
        if (this.noEventsContainer) {
            this.noEventsContainer.style.display = 'none !important';
            this.noEventsContainer.style.visibility = 'hidden';
            this.noEventsContainer.style.opacity = '0';
            this.noEventsContainer.classList.remove('show');
        }
        
        // Show event banner
        this.eventBannerContainer.style.display = 'block';
        this.eventBannerContainer.style.visibility = 'visible';
        this.eventBannerContainer.style.opacity = '1';
        this.eventBannerContainer.classList.add('reveal-in');
        
        console.log('✅ Event banner shown, no-events hidden');
    }
    ...
    showNoEvents() {
        console.log('📭 SHOWING NO EVENTS STATE IN BANNER');
        
        // Hide the separate no-events section
        if (this.noEventsContainer) {
            this.noEventsContainer.style.display = 'none';
        }
        
        // Show event banner with no-events message inside
        if (this.eventBannerContainer) {
            this.eventBannerContainer.style.display = 'block';
            this.eventBannerContainer.style.visibility = 'visible';
            this.eventBannerContainer.style.opacity = '1';
            this.eventBannerContainer.classList.add('no-events-banner');
            
            // Clear existing content and add no-events message
        ...
        console.log('✅ No events message displayed inside banner');
    }
}
